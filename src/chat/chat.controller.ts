...
export class ChatController {
  ...
  @Post()
  @Auth("user")
  createChat(@CurrentUser("id") userId: number, @Body() createChatDto: CreateChatDto) {
  ...
  @Patch(":id")
  @Auth("user")
  updateChat(@CurrentUser("id") userId: number, @Param("id") id: string, @Body() updateChatDto: UpdateChatDto) {
